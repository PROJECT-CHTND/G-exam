...
export const concepts: Concept[] = [
  ...
  },
  {
    ...
    // 単一のeraに絞れない(1960年代の知識表現から現在のLLMまで続くタスク)ため、timelineアンカーを付与せずdraftのまま残す。
  },
  {
    id: "watson",
    term: "ワトソン",
    ...
    // Question-Answering同様、2011年という日付はあるが1つのeraの物語(壁・突破)には位置づけにくいため、
    // timelineアンカーを無理に付与せずdraftのまま残す。
  },
  {
    id: "todai-robot",
    term: "東ロボくん",
    ...
    // Watson同様、単一のeraに絞れないためtimelineアンカーを付与せずdraftのまま残す。
  },
  {
    id: "semantic-web",
    term: "セマンティックWeb",
    ...
    // 提唱(2001年頃)から現在まで発展が続く構想であり、単一のeraに絞れないためtimelineアンカーを付与せずdraftのまま残す。
  },
  {
    id: "web-mining",
    term: "ウェブマイニング",
    ...
    // データマイニングの一分野であり、それ自体が特定のeraの物語に紐づく技術ではないためtimelineアンカーは付与しない。
  },
  {
    id: "data-mining",
    term: "データマイニング",
